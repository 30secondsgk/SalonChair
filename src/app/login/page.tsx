      ...
      <Card className="w-full max-w-md rounded-3xl border-none shadow-xl overflow-hidden">
        ...
        <CardContent className="p-8 pt-10">
          <Button 
            ...
            className="w-full py-8 rounded-2xl shadow-lg shadow-primary/20 text-lg font-bold flex items-center justify-center gap-3 bg-white text-foreground hover:bg-muted border border-border"
          >
